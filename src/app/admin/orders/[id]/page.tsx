...
import { statusLabels, statusColors, OrderStatus } from "@/lib/adminData";
...
export default function AdminOrderDetailsPage({
    ...
    const [order, setOrder] = useState<Order>(initValue);
    ...
    return (
        <div className="mx-auto max-w-3xl space-y-6">
            ...
            <Link
                href="/admin/orders"
                className="inline-flex items-center gap-2 text-sm font-bold text-[#71896A] hover:text-[#5B6F55]"
            >
            ...
            <div className="rounded-2xl bg-white p-6 shadow-soft">
                <div className="flex flex-wrap items-start justify-between gap-4">
                    <div>
                        <h2 className="font-display text-xl font-bold text-[#2A2E26]">
                            {order.id}
                        </h2>
                        ...
                        {steps.map((step, i) => (
                            ...
                            >
                                <div className="flex flex-col items-center gap-1">
                                    ...
                                    <span className="text-[10px] text-[#9A9F8F] whitespace-nowrap">
                                        {statusLabels[step]}
                                    </span>
                                </div>
                                {i < steps.length - 1 && (
            ...
            <div className="grid gap-6 lg:grid-cols-[1fr_280px]">
                {/* Items */}
                <div className="rounded-2xl bg-white p-6 shadow-soft">
                    <h3 className="mb-4 font-display text-base font-bold text-[#2A2E26]">
                        المنتجات
                    </h3>
                        ...
                        {order.items.map((item, i) => (
                            <div key={i} className="flex items-center gap-3">
                                ...
                                <div className="flex-1">
                                    <p className="text-sm font-semibold text-[#2A2E26]">
                                        {item.product.name}
                                    </p>
                                ...
                                <p className="font-bold text-[#C9925E]">
                                    {currency(
                    ...
                    <div className="mt-4 flex items-center justify-between border-t border-[#E3DECF] pt-4">
                        <span className="font-display font-bold text-[#2A2E26]">
                            الإجمالي
                        </span>
                        <span className="font-display text-lg font-bold text-[#C9925E]">
                ...
                <div className="space-y-5">
                    ...
                    <div className="rounded-2xl bg-white p-5 shadow-soft space-y-2">
                        <h3 className="font-display text-sm font-bold text-[#2A2E26]">
                            بيانات العميل
                        </h3>
                        <p className="text-sm font-semibold text-[#2A2E26]">
                            {order.customerName}
                        </p>
                        <p className="text-xs text-[#666C5E]" dir="ltr">
                            {order.phone}
                        </p>
                        <p className="text-xs text-[#666C5E]">
                                ...
                                <label
                                    ...
                                    className={cn(
                                        ...
                                        selected === s
                                            ...
                                            : "border-[#E3DECF] hover:border-[#A2B79B]",
                                    )}
                                >
                                    <input
                                        type="radio"
